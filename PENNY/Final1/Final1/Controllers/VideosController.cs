...
namespace Final1.Controllers
{
    public class VideosController : Controller
    {
        ...
        {
            var videos = db.Videos.Include(v => v.Encoding);
        ...
        {
            ViewBag.EncodingID = new SelectList(db.Encodings, "ID", "Codec");
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Title,MyDescription,FrameRate,EncodingID")] Video video)
        {
            if (ModelState.IsValid)
            {
